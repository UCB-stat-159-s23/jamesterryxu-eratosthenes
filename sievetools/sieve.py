...
def get_primes(nmax,method):
    # takes in method: fast or slow string
    if method == 'fast':
        all_primes = sieve_fast(nmax)
    elif method == 'slow':
        all_primes = sieve_slow(nmax)
    else:
        return None
    return all_primes

def proportion_primes(nmax,all_nmax):
    '''
    Gets the proportion of primes
    '''
    all_proportions = []
